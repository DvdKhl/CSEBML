...
namespace CSEBML.DocTypes.Matroska {
	public class MatroskaDocType : IDocType {
		...
		private static IEnumerable<MatroskaDocMetaElement> CreateMetaData() {
			...
			yield return new MatroskaDocMetaElement(0x18538067, "123WMaMu", null, null, null, "This element contains all other top-level (level 1) elements. Typically a Matroska file is composed of 1 segment.");
			yield return new MatroskaDocMetaElement(0x114D9B74, "123W  Mu", null, null, new int[] { Segment.Id }, "Contains the position of other level 1 elements.");
			yield return new MatroskaDocMetaElement(0x00004DBB, "123WMaMu", null, null, new int[] { SeekHead.Id }, "Contains a single seek entry to an EBML element.");
			yield return new MatroskaDocMetaElement(0x000053AB, "123WMa  ", null, null, new int[] { Seek.Id }, "The binary ID corresponding to the element name.");
			yield return new MatroskaDocMetaElement(0x000053AC, "123WMa  ", null, null, new int[] { Seek.Id }, "The position of the element in the segment in octets (0 = first level 1 element).");
			yield return new MatroskaDocMetaElement(0x1549A966, "123WMaMu", null, null, new int[] { Segment.Id }, "Contains miscellaneous general information and statistics on the file.");
			yield return new MatroskaDocMetaElement(0x000073A4, "123     ", null, val => val is Byte[] && !(new Guid((Byte[])val)).Equals(new Guid(new Byte[16])), new int[] { Info.Id }, "A randomly generated unique ID to identify the current segment between many others (128 bits).");
			yield return new MatroskaDocMetaElement(0x00007384, "123     ", null, null, new int[] { Info.Id }, "A filename corresponding to this segment.");
			yield return new MatroskaDocMetaElement(0x003CB923, "123     ", null, null, new int[] { Info.Id }, "A unique ID to identify the previous chained segment (128 bits).");
			yield return new MatroskaDocMetaElement(0x003C83AB, "123     ", null, null, new int[] { Info.Id }, "An escaped filename corresponding to the previous segment.");
			yield return new MatroskaDocMetaElement(0x003EB923, "123     ", null, null, new int[] { Info.Id }, "A unique ID to identify the next chained segment (128 bits).");
			yield return new MatroskaDocMetaElement(0x003E83BB, "123     ", null, null, new int[] { Info.Id }, "An escaped filename corresponding to the next segment.");
			yield return new MatroskaDocMetaElement(0x00004444, "123   Mu", null, null, new int[] { Info.Id }, "A randomly generated unique ID that all segments related to each other must use (128 bits).");
			yield return new MatroskaDocMetaElement(0x00006924, "123   Mu", null, null, new int[] { Info.Id }, "A tuple of corresponding ID used by chapter codecs to represent this segment.");
			yield return new MatroskaDocMetaElement(0x000069FC, "123   Mu", null, null, new int[] { ChapterTranslate.Id }, "Specify an edition UID on which this correspondance applies. When not specified, it means for all editions found in the segment.");
			yield return new MatroskaDocMetaElement(0x000069BF, "123 Ma  ", null, null, new int[] { ChapterTranslate.Id }, "The chapter codec using this ID (0: Matroska Script, 1: DVD-menu).");
			yield return new MatroskaDocMetaElement(0x000069A5, "123 Ma  ", null, null, new int[] { ChapterTranslate.Id }, "The binary value used to represent this segment in the chapter codec data. The format depends on the ChapProcessCodecID used.");
			yield return new MatroskaDocMetaElement(0x002AD7B1, "123WMa  ", 1000000UL, null, new int[] { Info.Id }, "Timecode scale in nanoseconds (1.000.000 means all timecodes in the segment are expressed in milliseconds).");
			yield return new MatroskaDocMetaElement(0x00004489, "123W    ", null, val => val is float && (float)val > 0, new int[] { Info.Id }, "Duration of the segment (based on TimecodeScale).");
			yield return new MatroskaDocMetaElement(0x00004461, "123W    ", null, null, new int[] { Info.Id }, "Date of the origin of timecode (value 0), i.e. production date.");
			yield return new MatroskaDocMetaElement(0x00007BA9, "123     ", null, null, new int[] { Info.Id }, "General name of the segment.");
			yield return new MatroskaDocMetaElement(0x00004D80, "123WMa  ", null, null, new int[] { Info.Id }, "Muxing application or library ('libmatroska-0.4.3').");
			yield return new MatroskaDocMetaElement(0x00005741, "123WMa  ", null, null, new int[] { Info.Id }, "Writing application ('mkvmerge-0.3.3').");
			yield return new MatroskaDocMetaElement(0x1F43B675, "123W  Mu", null, null, new int[] { Segment.Id }, "The lower level element containing the (monolithic) Block structure.");
			yield return new MatroskaDocMetaElement(0x000000E7, "123WMa  ", null, null, new int[] { Cluster.Id }, "Absolute timecode of the cluster (based on TimecodeScale).");
			yield return new MatroskaDocMetaElement(0x00005854, "123     ", null, null, new int[] { Cluster.Id }, "The list of tracks that are not used in that part of the stream. It is useful when using overlay tracks on seeking. Then you should decide what track to use.");
			yield return new MatroskaDocMetaElement(0x000058D7, "123   Mu", null, null, new int[] { SilentTracks.Id }, "One of the track number that are not used from now on in the stream. It could change later if not specified as silent in a further Cluster.");
			yield return new MatroskaDocMetaElement(0x000000A7, "123     ", null, null, new int[] { Cluster.Id }, "The Position of the Cluster in the segment (0 in live broadcast streams). It might help to resynchronise offset on damaged streams.");
			yield return new MatroskaDocMetaElement(0x000000AB, "123W    ", null, null, new int[] { Cluster.Id }, "Size of the previous Cluster, in octets. Can be useful for backward playing.");
			yield return new MatroskaDocMetaElement(0x000000A3, " 23W  Mu", null, null, new int[] { Cluster.Id }, "Similar to Block but without all the extra information, mostly used to reduced overhead when no extra feature is needed. (see SimpleBlock Structure)");
			yield return new MatroskaDocMetaElement(0x000000A0, "123W  Mu", null, null, new int[] { Cluster.Id }, "Basic container of information containing a single Block or BlockVirtual, and information specific to that Block/VirtualBlock.");
			yield return new MatroskaDocMetaElement(0x000000A1, "123WMa  ", null, null, new int[] { BlockGroup.Id }, "Block containing the actual data to be rendered and a timecode relative to the Cluster Timecode. (see Block Structure)");
			...
			yield return new MatroskaDocMetaElement(0x000075A1, "123     ", null, null, new int[] { BlockGroup.Id }, "Contain additional blocks to complete the main one. An EBML parser that has no knowledge of the Block structure could still see and use/skip these data.");
			yield return new MatroskaDocMetaElement(0x000000A6, "123 MaMu", null, null, new int[] { BlockAdditions.Id }, "Contain the BlockAdditional and some parameters.");
			yield return new MatroskaDocMetaElement(0x000000EE, "123 Ma  ", 1UL, val => val is UInt64 && (UInt64)val != 0, new int[] { BlockMore.Id }, "An ID to identify the BlockAdditional level.");
			yield return new MatroskaDocMetaElement(0x000000A5, "123 Ma  ", null, null, new int[] { BlockMore.Id }, "Interpreted by the codec as it wishes (using the BlockAddID).");
			yield return new MatroskaDocMetaElement(0x0000009B, "123W    ", "&TrackDuration", null, new int[] { BlockGroup.Id }, "The duration of the Block (based on TimecodeScale). This element is mandatory when DefaultDuration is set for the track. When not written and with no DefaultDuration, the value is assumed to be the difference between the timecode of this Block and the timecode of the next Block in 'display' order (not coding order). This element can be useful at the end of a Track (as there is not other Block available), or when there is a break in a track like for subtitle tracks.");
			yield return new MatroskaDocMetaElement(0x000000FA, "123 Ma  ", 0UL, null, new int[] { BlockGroup.Id }, "This frame is referenced and has the specified cache priority. In cache only a frame of the same or higher priority can replace this frame. A value of 0 means the frame is not referenced.");
			yield return new MatroskaDocMetaElement(0x000000FB, "123W  Mu", null, null, new int[] { BlockGroup.Id }, "Timecode of another frame used as a reference (ie: B or P frame). The timecode is relative to the block it's attached to.");
			...
			yield return new MatroskaDocMetaElement(0x000000A4, " 23     ", null, null, new int[] { BlockGroup.Id }, "The new codec state to use. Data interpretation is private to the codec. This information should always be referenced by a seek entry.");
			yield return new MatroskaDocMetaElement(0x0000008E, "123W    ", null, null, new int[] { BlockGroup.Id }, "Contains slices description.");
			yield return new MatroskaDocMetaElement(0x000000E8, "123W  Mu", null, null, new int[] { Slices.Id }, "Contains extra time information about the data contained in the Block. While there are a few files in the wild with this element, it is no longer in use and has been deprecated. Being able to interpret this element is not required for playback.");
			yield return new MatroskaDocMetaElement(0x000000CC, "123W    ", 0UL, null, new int[] { TimeSlice.Id }, "The reverse number of the frame in the lace (0 is the last frame, 1 is the next to last, etc). While there are a few files in the wild with this element, it is no longer in use and has been deprecated. Being able to interpret this element is not required for playback.");
			...
			yield return new MatroskaDocMetaElement(0x1654AE6B, "123W  Mu", null, null, new int[] { Segment.Id }, "A top-level block of information with many tracks described.");
			yield return new MatroskaDocMetaElement(0x000000AE, "123WMaMu", null, null, new int[] { Tracks.Id }, "Describes a track with all elements.");
			yield return new MatroskaDocMetaElement(0x000000D7, "123WMa  ", null, val => val is UInt64 && (UInt64)val != 0, new int[] { TrackEntry.Id }, "The track number as used in the Block Header (using more than 127 tracks is not encouraged, though the design allows an unlimited number).");
			yield return new MatroskaDocMetaElement(0x000073C5, "123WMa  ", null, val => val is UInt64 && (UInt64)val != 0, new int[] { TrackEntry.Id }, "A unique ID to identify the Track. This should be kept the same when making a direct stream copy of the Track to another file.");
			yield return new MatroskaDocMetaElement(0x00000083, "123WMa  ", null, val => val is UInt64 && (UInt64)val != 0 && (UInt64)val < 255, new int[] { TrackEntry.Id }, "A set of track types coded on 8 bits (1: video, 2: audio, 3: complex, 0x10: logo, 0x11: subtitle, 0x12: buttons, 0x20: control).");
			yield return new MatroskaDocMetaElement(0x000000B9, " 23WMa  ", 1UL, val => val is UInt64 && ((UInt64)val == 0 || (UInt64)val == 1), new int[] { TrackEntry.Id }, "Set if the track is used. (1 bit)");
			yield return new MatroskaDocMetaElement(0x00000088, "123WMa  ", 1UL, val => val is UInt64 && ((UInt64)val == 0 || (UInt64)val == 1), new int[] { TrackEntry.Id }, "Set if that track (audio, video or subs) SHOULD be used if no language found matches the user preference. (1 bit)");
			yield return new MatroskaDocMetaElement(0x000055AA, "123WMa  ", 0UL, val => val is UInt64 && ((UInt64)val == 0 || (UInt64)val == 1), new int[] { TrackEntry.Id }, "Set if that track MUST be used during playback. There can be many forced track for a kind (audio, video or subs), the player should select the one which language matches the user preference or the default + forced track. Overlay MAY happen between a forced and non-forced track of the same kind. (1 bit)");
			yield return new MatroskaDocMetaElement(0x0000009C, "123WMa  ", 1UL, val => val is UInt64 && ((UInt64)val == 0 || (UInt64)val == 1), new int[] { TrackEntry.Id }, "Set if the track may contain blocks using lacing. (1 bit)");
			yield return new MatroskaDocMetaElement(0x00006DE7, "123 Ma  ", 0UL, null, new int[] { TrackEntry.Id }, "The minimum number of frames a player should be able to cache during playback. If set to 0, the reference pseudo-cache system is not used.");
			yield return new MatroskaDocMetaElement(0x00006DF8, "123     ", null, null, new int[] { TrackEntry.Id }, "The maximum cache size required to store referenced frames in and the current frame. 0 means no cache is needed.");
			yield return new MatroskaDocMetaElement(0x0023E383, "123W    ", null, notNull, new int[] { TrackEntry.Id }, "Number of nanoseconds (i.e. not scaled) per frame.");
			yield return new MatroskaDocMetaElement(0x0023314F, "123 Ma  ", 1.0f, greaterNull, new int[] { TrackEntry.Id }, "The scale to apply on this track to work at normal speed in relation with other tracks (mostly used to adjust video speed when the audio length differs).");
			...
			yield return new MatroskaDocMetaElement(0x000055EE, "123 Ma  ", 0UL, null, new int[] { TrackEntry.Id }, "The maximum value of BlockAddID. A value 0 means there is no BlockAdditions for this track.");
			yield return new MatroskaDocMetaElement(0x0000536E, "123W    ", null, null, new int[] { TrackEntry.Id }, "A human-readable track name.");
			yield return new MatroskaDocMetaElement(0x0022B59C, "123W    ", "eng", null, new int[] { TrackEntry.Id }, "Specifies the language of the track in the Matroska languages form.");
			yield return new MatroskaDocMetaElement(0x00000086, "123WMa  ", null, null, new int[] { TrackEntry.Id }, "An ID corresponding to the codec, see the codec page for more info.");
			yield return new MatroskaDocMetaElement(0x000063A2, "123W    ", null, null, new int[] { TrackEntry.Id }, "Private data only known to the codec.");
			yield return new MatroskaDocMetaElement(0x00258688, "123W    ", null, null, new int[] { TrackEntry.Id }, "A human-readable string specifying the codec.");
			yield return new MatroskaDocMetaElement(0x00007446, "123     ", null, notNull, new int[] { TrackEntry.Id }, "The UID of an attachment that is used by this codec.");
			...
			yield return new MatroskaDocMetaElement(0x000000AA, " 23 Ma  ", 1UL, zeroOrOne, new int[] { TrackEntry.Id }, "The codec can decode potentially damaged data (1 bit).");
			yield return new MatroskaDocMetaElement(0x00006FAB, "123   Mu", null, null, new int[] { TrackEntry.Id }, "Specify that this track is an overlay track for the Track specified (in the u-integer). That means when this track has a gap (see SilentTracks) the overlay track should be used instead. The order of multiple TrackOverlay matters, the first one is the one that should be used. If not found it should be the second, etc.");
			yield return new MatroskaDocMetaElement(0x00006624, "123   Mu", null, null, new int[] { TrackEntry.Id }, "The track identification for the given Chapter Codec.");
			yield return new MatroskaDocMetaElement(0x000066FC, "123   Mu", null, null, new int[] { TrackTranslate.Id }, "Specify an edition UID on which this translation applies. When not specified, it means for all editions found in the segment.");
			yield return new MatroskaDocMetaElement(0x000066BF, "123 Ma  ", null, null, new int[] { TrackTranslate.Id }, "The chapter codec using this ID (0: Matroska Script, 1: DVD-menu).");
			yield return new MatroskaDocMetaElement(0x000066A5, "123 Ma  ", null, null, new int[] { TrackTranslate.Id }, "The binary value used to represent this track in the chapter codec data. The format depends on the ChapProcessCodecID used.");
			yield return new MatroskaDocMetaElement(0x000000E0, "123W    ", null, null, new int[] { TrackEntry.Id }, "Video settings.");
			yield return new MatroskaDocMetaElement(0x0000009A, " 23WMa  ", 0UL, zeroOrOne, new int[] { Video.Id }, "Set if the video is interlaced. (1 bit)");
			yield return new MatroskaDocMetaElement(0x000053B8, "  3W    ", 0UL, null, new int[] { Video.Id }, "Stereo-3D video mode (0: mono, 1: side by side (left eye is first), 2: top-bottom (right eye is first), 3: top-bottom (left eye is first), 4: checkboard (right is first), 5: checkboard (left is first), 6: row interleaved (right is first), 7: row interleaved (left is first), 8: column interleaved (right is first), 9: column interleaved (left is first), 10: anaglyph (cyan/red), 11: side by side (right eye is first), 12: anaglyph (green/magenta), 13 both eyes laced in one Block (left eye is first), 14 both eyes laced in one Block (right eye is first)). There are some more details on 3D support in the Specification Notes.");
			...
			yield return new MatroskaDocMetaElement(0x000000B0, "123WMa  ", null, notNull, new int[] { Video.Id }, "Width of the encoded video frames in pixels.");
			yield return new MatroskaDocMetaElement(0x000000BA, "123WMa  ", null, notNull, new int[] { Video.Id }, "Height of the encoded video frames in pixels.");
			yield return new MatroskaDocMetaElement(0x000054AA, "123W    ", 0UL, null, new int[] { Video.Id }, "The number of video pixels to remove at the bottom of the image (for HDTV content).");
			yield return new MatroskaDocMetaElement(0x000054BB, "123W    ", 0UL, null, new int[] { Video.Id }, "The number of video pixels to remove at the top of the image.");
			yield return new MatroskaDocMetaElement(0x000054CC, "123W    ", 0UL, null, new int[] { Video.Id }, "The number of video pixels to remove on the left of the image.");
			yield return new MatroskaDocMetaElement(0x000054DD, "123W    ", 0UL, null, new int[] { Video.Id }, "The number of video pixels to remove on the right of the image.");
			yield return new MatroskaDocMetaElement(0x000054B0, "123W    ", "&PixelWidth", notNull, new int[] { Video.Id }, "Width of the video frames to display. The default value is only valid when DisplayUnit is 0.");
			yield return new MatroskaDocMetaElement(0x000054BA, "123W    ", "&PixelHeight", notNull, new int[] { Video.Id }, "Height of the video frames to display. The default value is only valid when DisplayUnit is 0.");
			yield return new MatroskaDocMetaElement(0x000054B2, "123W    ", 0UL, null, new int[] { Video.Id }, "How DisplayWidth & DisplayHeight should be interpreted (0: pixels, 1: centimeters, 2: inches, 3: Display Aspect Ratio).");
			yield return new MatroskaDocMetaElement(0x000054B3, "123W    ", 0UL, null, new int[] { Video.Id }, "Specify the possible modifications to the aspect ratio (0: free resizing, 1: keep aspect ratio, 2: fixed).");
			yield return new MatroskaDocMetaElement(0x002EB524, "123     ", null, null, new int[] { Video.Id }, "Same value as in AVI (32 bits).");
			...
			yield return new MatroskaDocMetaElement(0x000000E1, "123W    ", null, null, new int[] { TrackEntry.Id }, "Audio settings.");
			yield return new MatroskaDocMetaElement(0x000000B5, "123WMa  ", 8000.0f, greaterNull, new int[] { Audio.Id }, "Sampling frequency in Hz.");
			yield return new MatroskaDocMetaElement(0x000078B5, "123W    ", "&SamplingFrequency", greaterNull, new int[] { Audio.Id }, "Real output sampling frequency in Hz (used for SBR techniques).");
			yield return new MatroskaDocMetaElement(0x0000009F, "123WMa  ", 1UL, notNull, new int[] { Audio.Id }, "Numbers of channels in the track.");
			...
			yield return new MatroskaDocMetaElement(0x00006264, "123W    ", null, notNull, new int[] { Audio.Id }, "Bits per sample, mostly used for PCM.");
			yield return new MatroskaDocMetaElement(0x000000E2, "  3     ", null, null, new int[] { TrackEntry.Id }, "Operation that needs to be applied on tracks to create this virtual track. For more details look at the Specification Notes on the subject.");
			yield return new MatroskaDocMetaElement(0x000000E3, "  3     ", null, null, new int[] { TrackOperation.Id }, "Contains the list of all video plane tracks that need to be combined to create this 3D track");
			yield return new MatroskaDocMetaElement(0x000000E4, "  3 MaMu", null, null, new int[] { TrackCombinePlanes.Id }, "Contains a video plane track that need to be combined to create this 3D track");
			yield return new MatroskaDocMetaElement(0x000000E5, "  3 Ma  ", null, notNull, new int[] { TrackPlane.Id }, "The trackUID number of the track representing the plane.");
			yield return new MatroskaDocMetaElement(0x000000E6, "  3 Ma  ", null, null, new int[] { TrackPlane.Id }, "The kind of plane this track corresponds to (0: left eye, 1: right eye, 2: background).");
			yield return new MatroskaDocMetaElement(0x000000E9, "  3     ", null, null, new int[] { TrackOperation.Id }, "Contains the list of all tracks whose Blocks need to be combined to create this virtual track");
			yield return new MatroskaDocMetaElement(0x000000ED, "  3 MaMu", null, notNull, new int[] { TrackJoinBlocks.Id }, "The trackUID number of a track whose blocks are used to create this virtual track.");
			...
			yield return new MatroskaDocMetaElement(0x00006D80, "123     ", null, null, new int[] { TrackEntry.Id }, "Settings for several content encoding mechanisms like compression or encryption.");
			yield return new MatroskaDocMetaElement(0x00006240, "123 MaMu", null, null, new int[] { ContentEncodings.Id }, "Settings for one content encoding like compression or encryption.");
			yield return new MatroskaDocMetaElement(0x00005031, "123 Ma  ", 0UL, null, new int[] { ContentEncoding.Id }, "Tells when this modification was used during encoding/muxing starting with 0 and counting upwards. The decoder/demuxer has to start with the highest order number it finds and work its way down. This value has to be unique over all ContentEncodingOrder elements in the segment.");
			yield return new MatroskaDocMetaElement(0x00005032, "123 Ma  ", 1UL, notNull, new int[] { ContentEncoding.Id }, "A bit field that describes which elements have been modified in this way. Values (big endian) can be OR'ed. Possible values: \n1 - all frame contents,\n2 - the track's private data,\n4 - the next ContentEncoding (next ContentEncodingOrder. Either the data inside ContentCompression and/or ContentEncryption)");
			yield return new MatroskaDocMetaElement(0x00005033, "123 Ma  ", 0UL, null, new int[] { ContentEncoding.Id }, "A value describing what kind of transformation has been done. Possible values:\n0 - compression,\n1 - encryption");
			yield return new MatroskaDocMetaElement(0x00005034, "123     ", null, null, new int[] { ContentEncoding.Id }, "Settings describing the compression used. Must be present if the value of ContentEncodingType is 0 and absent otherwise. Each block must be decompressable even if no previous block is available in order not to prevent seeking.");
			yield return new MatroskaDocMetaElement(0x00004254, "123 Ma  ", 0UL, null, new int[] { ContentCompression.Id }, "The compression algorithm used. Algorithms that have been specified so far are:\n0 - zlib,\n1 - bzlib,\n2 - lzo1x\n3 - Header Stripping");
			yield return new MatroskaDocMetaElement(0x00004255, "123     ", null, null, new int[] { ContentCompression.Id }, "Settings that might be needed by the decompressor. For Header Stripping (ContentCompAlgo=3), the bytes that were removed from the beggining of each frames of the track.");
			yield return new MatroskaDocMetaElement(0x00005035, "123     ", null, null, new int[] { ContentEncoding.Id }, "Settings describing the encryption used. Must be present if the value of ContentEncodingType is 1 and absent otherwise.");
			yield return new MatroskaDocMetaElement(0x000047E1, "123     ", 0UL, null, new int[] { ContentEncryption.Id }, "The encryption algorithm used. The value '0' means that the contents have not been encrypted but only signed. Predefined values:\n1 - DES, 2 - 3DES, 3 - Twofish, 4 - Blowfish, 5 - AES");
			yield return new MatroskaDocMetaElement(0x000047E2, "123     ", null, null, new int[] { ContentEncryption.Id }, "For public key algorithms this is the ID of the public key the the data was encrypted with.");
			yield return new MatroskaDocMetaElement(0x000047E3, "123     ", null, null, new int[] { ContentEncryption.Id }, "A cryptographic signature of the contents.");
			yield return new MatroskaDocMetaElement(0x000047E4, "123     ", null, null, new int[] { ContentEncryption.Id }, "This is the ID of the private key the data was signed with.");
			yield return new MatroskaDocMetaElement(0x000047E5, "123     ", 0UL, null, new int[] { ContentEncryption.Id }, "The algorithm used for the signature. A value of '0' means that the contents have not been signed but only encrypted. Predefined values:\n1 - RSA");
			yield return new MatroskaDocMetaElement(0x000047E6, "123     ", 0UL, null, new int[] { ContentEncryption.Id }, "The hash algorithm used for the signature. A value of '0' means that the contents have not been signed but only encrypted. Predefined values:\n1 - SHA1-160\n2 - MD5");
			yield return new MatroskaDocMetaElement(0x1C53BB6B, "123W    ", null, null, new int[] { Segment.Id }, "A top-level element to speed seeking access. All entries are local to the segment. Should be mandatory for non 'live' streams.");
			yield return new MatroskaDocMetaElement(0x000000BB, "123WMaMu", null, null, new int[] { Cues.Id }, "Contains all information relative to a seek point in the segment.");
			yield return new MatroskaDocMetaElement(0x000000B3, "123WMa  ", null, null, new int[] { CuePoint.Id }, "Absolute timecode according to the segment time base.");
			yield return new MatroskaDocMetaElement(0x000000B7, "123WMaMu", null, null, new int[] { CuePoint.Id }, "Contain positions for different tracks corresponding to the timecode.");
			yield return new MatroskaDocMetaElement(0x000000F7, "123WMa  ", null, notNull, new int[] { CueTrackPositions.Id }, "The track for which a position is given.");
			yield return new MatroskaDocMetaElement(0x000000F1, "123WMa  ", null, null, new int[] { CueTrackPositions.Id }, "The position of the Cluster containing the required Block.");
			yield return new MatroskaDocMetaElement(0x00005378, "123W    ", 1UL, notNull, new int[] { CueTrackPositions.Id }, "Number of the Block in the specified Cluster.");
			yield return new MatroskaDocMetaElement(0x000000EA, " 23     ", 0UL, null, new int[] { CueTrackPositions.Id }, "The position of the Codec State corresponding to this Cue element. 0 means that the data is taken from the initial Track Entry.");
			yield return new MatroskaDocMetaElement(0x000000DB, " 23   Mu", null, null, new int[] { CueTrackPositions.Id }, "The Clusters containing the required referenced Blocks.");
			yield return new MatroskaDocMetaElement(0x00000096, " 23 Ma  ", null, null, new int[] { CueReference.Id }, "Timecode of the referenced Block.");
			...
			yield return new MatroskaDocMetaElement(0x1941A469, "123     ", null, null, new int[] { Segment.Id }, "Contain attached files.");
			yield return new MatroskaDocMetaElement(0x000061A7, "123 MaMu", null, null, new int[] { Attachments.Id }, "An attached file.");
			yield return new MatroskaDocMetaElement(0x0000467E, "123     ", null, null, new int[] { AttachedFile.Id }, "A human-friendly name for the attached file.");
			yield return new MatroskaDocMetaElement(0x0000466E, "123 Ma  ", null, null, new int[] { AttachedFile.Id }, "Filename of the attached file.");
			yield return new MatroskaDocMetaElement(0x00004660, "123 Ma  ", null, null, new int[] { AttachedFile.Id }, "MIME type of the file.");
			yield return new MatroskaDocMetaElement(0x0000465C, "123 Ma  ", null, null, new int[] { AttachedFile.Id }, "The data of the file.");
			yield return new MatroskaDocMetaElement(0x000046AE, "123 Ma  ", null, notNull, new int[] { AttachedFile.Id }, "Unique ID representing the file, as random as possible.");
			...
			yield return new MatroskaDocMetaElement(0x1043A770, "123     ", null, null, new int[] { Segment.Id }, "A system to define basic menus and partition data. For more detailed information, look at the Chapters Explanation.");
			yield return new MatroskaDocMetaElement(0x000045B9, "123 MaMu", null, null, new int[] { Chapters.Id }, "Contains all information about a segment edition.");
			yield return new MatroskaDocMetaElement(0x000045BC, "123     ", null, notNull, new int[] { EditionEntry.Id }, "A unique ID to identify the edition. It's useful for tagging an edition.");
			yield return new MatroskaDocMetaElement(0x000045BD, "123 Ma  ", 0UL, zeroOrOne, new int[] { EditionEntry.Id }, "If an edition is hidden (1), it should not be available to the user interface (but still to Control Tracks). (1 bit)");
			yield return new MatroskaDocMetaElement(0x000045DB, "123 Ma  ", 0UL, zeroOrOne, new int[] { EditionEntry.Id }, "If a flag is set (1) the edition should be used as the default one. (1 bit)");
			yield return new MatroskaDocMetaElement(0x000045DD, "123     ", 0UL, zeroOrOne, new int[] { EditionEntry.Id }, "Specify if the chapters can be defined multiple times and the order to play them is enforced. (1 bit)");
			yield return new MatroskaDocMetaElement(0x000000B6, "123 MaMu", null, null, new int[] { EditionEntry.Id, ChapterAtom.Id }, "Contains the atom information to use as the chapter atom (apply to all tracks).");
			yield return new MatroskaDocMetaElement(0x000073C4, "123 Ma  ", null, notNull, new int[] { ChapterAtom.Id }, "A unique ID to identify the Chapter.");
			yield return new MatroskaDocMetaElement(0x00000091, "123 Ma  ", null, null, new int[] { ChapterAtom.Id }, "Timecode of the start of Chapter (not scaled).");
			yield return new MatroskaDocMetaElement(0x00000092, "123     ", null, null, new int[] { ChapterAtom.Id }, "Timecode of the end of Chapter (timecode excluded, not scaled).");
			yield return new MatroskaDocMetaElement(0x00000098, "123 Ma  ", 0UL, zeroOrOne, new int[] { ChapterAtom.Id }, "If a chapter is hidden (1), it should not be available to the user interface (but still to Control Tracks). (1 bit)");
			yield return new MatroskaDocMetaElement(0x00004598, "123 Ma  ", 1UL, zeroOrOne, new int[] { ChapterAtom.Id }, "Specify wether the chapter is enabled. It can be enabled/disabled by a Control Track. When disabled, the movie should skip all the content between the TimeStart and TimeEnd of this chapter. (1 bit)");
			yield return new MatroskaDocMetaElement(0x00006E67, "123     ", null, greaterNull, new int[] { ChapterAtom.Id }, "A segment to play in place of this chapter. Edition ChapterSegmentEditionUID should be used for this segment, otherwise no edition is used.");
			yield return new MatroskaDocMetaElement(0x00006EBC, "123     ", null, notNull, new int[] { ChapterAtom.Id }, "The edition to play from the segment linked in ChapterSegmentUID.");
			yield return new MatroskaDocMetaElement(0x000063C3, "123     ", null, null, new int[] { ChapterAtom.Id }, "Specify the physical equivalent of this ChapterAtom like 'DVD' (60) or 'SIDE' (50), see complete list of values.");
			yield return new MatroskaDocMetaElement(0x0000008F, "123     ", null, null, new int[] { ChapterAtom.Id }, "List of tracks on which the chapter applies. If this element is not present, all tracks apply");
			yield return new MatroskaDocMetaElement(0x00000089, "123 MaMu", null, notNull, new int[] { ChapterTrack.Id }, "UID of the Track to apply this chapter too. In the absense of a control track, choosing this chapter will select the listed Tracks and deselect unlisted tracks. Absense of this element indicates that the Chapter should be applied to any currently used Tracks.");
			yield return new MatroskaDocMetaElement(0x00000080, "123   Mu", null, null, new int[] { ChapterAtom.Id }, "Contains all possible strings to use for the chapter display.");
			yield return new MatroskaDocMetaElement(0x00000085, "123 Ma  ", null, null, new int[] { ChapterDisplay.Id }, "Contains the string to use as the chapter atom.");
			yield return new MatroskaDocMetaElement(0x0000437C, "123 MaMu", "eng", null, new int[] { ChapterDisplay.Id }, "The languages corresponding to the string, in the bibliographic ISO-639-2 form.");
			yield return new MatroskaDocMetaElement(0x0000437E, "123   Mu", null, null, new int[] { ChapterDisplay.Id }, "The countries corresponding to the string, same 2 octets as in Internet domains.");
			yield return new MatroskaDocMetaElement(0x00006944, "123   Mu", null, null, new int[] { ChapterAtom.Id }, "Contains all the commands associated to the Atom.");
			yield return new MatroskaDocMetaElement(0x00006955, "123 Ma  ", 0UL, null, new int[] { ChapProcess.Id }, "Contains the type of the codec used for the processing. A value of 0 means native Matroska processing (to be defined), a value of 1 means the DVD command set is used. More codec IDs can be added later.");
			yield return new MatroskaDocMetaElement(0x0000450D, "123     ", null, null, new int[] { ChapProcess.Id }, "Some optional data attached to the ChapProcessCodecID information. For ChapProcessCodecID = 1, it is the 'DVD level' equivalent.");
			yield return new MatroskaDocMetaElement(0x00006911, "123   Mu", null, null, new int[] { ChapProcess.Id }, "Contains all the commands associated to the Atom.");
			yield return new MatroskaDocMetaElement(0x00006922, "123 Ma  ", null, null, new int[] { ChapProcessCommand.Id }, "Defines when the process command should be handled (0: during the whole chapter, 1: before starting playback, 2: after playback of the chapter).");
			yield return new MatroskaDocMetaElement(0x00006933, "123 Ma  ", null, null, new int[] { ChapProcessCommand.Id }, "Contains the command information. The data should be interpreted depending on the ChapProcessCodecID value. For ChapProcessCodecID = 1, the data correspond to the binary DVD cell pre/post commands.");
			yield return new MatroskaDocMetaElement(0x1254C367, "123   Mu", null, null, new int[] { Segment.Id }, "Element containing elements specific to Tracks/Chapters. A list of valid tags can be found here.");
			yield return new MatroskaDocMetaElement(0x00007373, "123 MaMu", null, null, new int[] { Tags.Id }, "Element containing elements specific to Tracks/Chapters.");
			yield return new MatroskaDocMetaElement(0x000063C0, "123 Ma  ", null, null, new int[] { Tag.Id }, "Contain all UIDs where the specified meta data apply. It is empty to describe everything in the segment.");
			yield return new MatroskaDocMetaElement(0x000068CA, "123     ", 50UL, null, new int[] { Targets.Id }, "A number to indicate the logical level of the target (see TargetType).");
			yield return new MatroskaDocMetaElement(0x000063CA, "123     ", null, null, new int[] { Targets.Id }, "An informational string that can be used to display the logical level of the target like 'ALBUM', 'TRACK', 'MOVIE', 'CHAPTER', etc (see TargetType).");
			yield return new MatroskaDocMetaElement(0x000063C5, "123   Mu", 0UL, null, new int[] { Targets.Id }, "A unique ID to identify the Track(s) the tags belong to. If the value is 0 at this level, the tags apply to all tracks in the Segment.");
			yield return new MatroskaDocMetaElement(0x000063C9, "123   Mu", 0UL, null, new int[] { Targets.Id }, "A unique ID to identify the EditionEntry(s) the tags belong to. If the value is 0 at this level, the tags apply to all editions in the Segment.");
			yield return new MatroskaDocMetaElement(0x000063C4, "123   Mu", 0UL, null, new int[] { Targets.Id }, "A unique ID to identify the Chapter(s) the tags belong to. If the value is 0 at this level, the tags apply to all chapters in the Segment.");
			yield return new MatroskaDocMetaElement(0x000063C6, "123   Mu", 0UL, null, new int[] { Targets.Id }, "A unique ID to identify the Attachment(s) the tags belong to. If the value is 0 at this level, the tags apply to all the attachments in the Segment.");
			yield return new MatroskaDocMetaElement(0x000067C8, "123 MaMu", null, null, new int[] { Tag.Id, SimpleTag.Id }, "Contains general information about the target.");
			yield return new MatroskaDocMetaElement(0x000045A3, "123 Ma  ", null, null, new int[] { SimpleTag.Id }, "The name of the Tag that is going to be stored.");
			yield return new MatroskaDocMetaElement(0x0000447A, "123 Ma  ", "und", null, new int[] { SimpleTag.Id }, "Specifies the language of the tag specified, in the Matroska languages form.");
